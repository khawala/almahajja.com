...
<div class="row">
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-sm-6">
            ...
            {!! Form::myInput('text', 'mobile1', 'جوال التواصل <span class=red>*</span>') !!}
            {!! Form::mySelect('nationality_id', 'الجنسية <span class=red>*</span>', App\Nationality::active()->pluck('name', 'id')->toArray()) !!}
            {!! Form::mySelect('gender', 'الجنس <span class=red>*</span>', config('variables.sexes')) !!}
            {!! Form::mySelect('status', 'الحالة <span class=red>*</span>', config('variables.status')) !!}
          </div>
          <div class="col-sm-6">
  ...
  <div class="col-sm-4">
    <div class="box box-danger">
      ...
      <div class="box-body">
        {!! Form::myInput('text', 'username', 'إسم المستخدم <span class=red>*</span>', ['required', $disabled]) !!}
