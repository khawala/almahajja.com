    ...
    <div class="container">
        <div id="mainSlider" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators">
                @foreach ($ads as $ad)
                    <li data-target="#mainSlider" data-slide-to="{{ $loop->index }}" {{ $loop->first ? 'class=active' : '' }}></li>
                @endforeach
            </ol>
    ...
    <div class="container">
        ...
        <div id="divisions" class="title-section">
            <div class="row justify-content-between">
                ...
                <div class="col-6">
                    <a href="{{url('/departments/list')}}" class="btn-title">عرض المزيد</a>
                </div>
            </div>
        </div>
        <!-- End Title Sections -->
                    ...
                    <div class="box">
                        ...
                        <div class="row justify-content-between text-right">
                            <div class="col-6">
                                <div class="one">
                                    <h6>تاريخ البدء</h6>
                                    <p>{{ $department->start_date }}</p>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="one">
                                    <h6>تاريخ الانتهاء</h6>
                                    <p>{{ $department->end_date }}</p>
                                </div>
                            </div>
                        </div>
                        <button class="cost" onclick="window.open('{{ route('department.show', $department) }} ')" style="width: 100%;cursor: pointer;border-style: solid;">
                            <span>رسوم التسجيل</span>  @if ($department->price) {{ $department->price }} ريال @else مجانا @endif
                        </button>
                    </div>
                </div>
            @endforeach
    ...
    <div class="container">
        ...
        <div class="title-section">
            <div class="row justify-content-between">
                ...
                <div class="col-6">
                    <a href="{{url('/job/list')}}" class="btn-title">عرض المزيد</a>
                </div>
            </div>
        </div>
        <!-- End Title Sections -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="sub text-right">
                                        <h6 style="font-weight: bold;">{{ $job->name }}</h6>
                                        <p>
                                            {{ $job->description }}
                                        </p>
                                    </div>
