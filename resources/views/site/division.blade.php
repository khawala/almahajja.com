    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-sm-9">
                    <h2>{{ $division->name }}</h2>
                    <p>{{ nl2br($division->description) }}</p>
                </div>
                <div class="col-sm-3">
                    <img src="{{ $division->photo }}" alt="">
                </div>
            </div>
        </div>
    </header>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tab-02">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                {!! Form::mySelect('section_id', 'المسار', ['' => ''] + App\Section::where('division_id', $division->id)->pluck('name', 'id')->toArray(), null, ['required']) !!}
