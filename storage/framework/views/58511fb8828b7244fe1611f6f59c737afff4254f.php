      ...
      <div class="box-body">
        <div class="row">
          <div class="col-sm-6">
            ...
            <?php echo Form::myInput('text', 'national_id', 'رقم الهوية <span class=red>*</span>', ['required']); ?>
  ...
  <div class="col-sm-4">
    <div class="box box-danger">
      ...
      <div class="box-body">
        ...
        <?php echo Form::mySelect('role', 'الصلاحيات <span class=red>*</span>', config('variables.roles'), null, ['required' , auth()->user()->isNotAdmin ? 'disabled' : '']); ?>
