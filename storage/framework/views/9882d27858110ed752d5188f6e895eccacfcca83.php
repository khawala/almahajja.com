...
<script>
    ...
    var divisionsByGender = new Chart(ctx, {
        ...
        data: {
            labels: [
                <?php $__currentLoopData = $divisionsByGender; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    "<?php echo e($divisions_genders[$e->gender]); ?> (<?php echo e($e->count); ?>)", 
