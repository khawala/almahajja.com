...
<script>
    ...
    var divisionsByStatus = new Chart(ctx, {
        ...
        data: {
            labels: [
                <?php $__currentLoopData = $divisionsByStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
