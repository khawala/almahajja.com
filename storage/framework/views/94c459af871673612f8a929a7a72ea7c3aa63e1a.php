...
?>
	...
	<div id="map-holder-<?php echo e($id); ?>" style="width:100%; height:500px; margin-bottom: 20px;"></div>
...
<script>
	...
	$(document).ready(function() {
	    ...
	    map = new google.maps.Map(document.getElementById("map-holder-<?php echo e($id); ?>"), options);
