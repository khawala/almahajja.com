...
<?php $__env->startSection('content'); ?>
    ...
    <ul class="list-inline">
        <li><a class="btn btn-info" href="<?php echo e(route(ADMIN . '.users.create')); ?>"><?php echo e(trans('app.add_button')); ?></a></li>
        <li class="pull-left">
            <a class="btn btn-success" href="<?php echo e(route(ADMIN . '.users.export',['role'=>request('role')])); ?>"><i class="fa fa-file-excel-o"></i></a>
        </li>
    </ul>
	        ...
	        <table class="table data-tables" cellspacing="0" width="100%">
                ...
                <tbody>
					<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
                            <td><a href="<?php echo e(route(ADMIN . '.users.edit', $item->id)); ?>"><?php echo e($item->id); ?></a></td>
	                        ...
	                        <td class="actions">
                                <ul class="list-inline">
                                    <li><a href="<?php echo e(route(ADMIN . '.users.edit', $item->id)); ?>" title="<?php echo e(trans('app.edit_title')); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a></li>
                                    <li>
                                        <?php echo Form::open([
                                            'class'=>'delete',
